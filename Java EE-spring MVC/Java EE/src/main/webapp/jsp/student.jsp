...
<%@ page import="main.java.model.addhomeworkmodel" %>
    ...
    <div style="position:absolute;width:300px;height:1000px;background-color:#f0f0f0;">
        <div id="mz"style="position:absolute;width:300px;top:40px;">
            <ul style="list-style-type:none;margin: 0;padding: 0;text-align:left;"><br />
                <li><a style="font-size:25px;text-decoration:none;color:#005bac;width:300px;display:inline-block;padding:0.5em 0 0.5em 0;" href="<%=request.getContextPath()%>/main/webapp/jsp/student.jsp"> &emsp;&emsp;&emsp;&emsp;查看作业 </a></li>
            </ul>
        </div>
    </div>
